 ...
 */
final class Version20210723185710 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pedido DROP cliente_id, DROP preciototal');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pedido ADD cliente_id INT NOT NULL, ADD preciototal NUMERIC(5, 2) NOT NULL');
